...
insert into video(category_id, video_source, name, description, author) values
	...
	(1, 'https://www.youtube.com/embed/WLniDsuVzuc', 'EL DÍA DESPÚES DE MAÑANA', 'Cuando una nueva Edad de hielo amenaza al mundo, el climatólogo Jack Hall intenta salvar a la humanidad desde Nueva York, al mismo tiempo que busca a su hijo Sam.', 'Cine Studios'),
	(1, 'https://www.youtube.com/embed/P7ND_UtFOD0', 'Juno', 'Juno Enfrentada a un embarazo no planificado, una mujer joven poco convencional toma una decisión inusual con respecto a su hijo por nacer.', 'Paramount Pictures'),
